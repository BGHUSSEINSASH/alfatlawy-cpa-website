...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ...
        ku: {
            ...
            'team.m1_name': 'ژمێریاری یاسایی ئەکرەم کەریم',
        ...
        fa: {
            ...
            'team.m1_name': 'حسابدار قانونی اکرم کریم',
        ...
        ru: {
            ...
            'contact.whatsapp': 'WhatsApp',
            'team.m1_name': 'Дипл. бухгалтер Акрам Карим',
    ...
    if (chatToggle && chatPanel) {
        ...
        var companyContext = [
            ...
            '',
            '=== الفريق القيادي ===',
            '• اكرم كريم — المؤسس والشريك الإداري (ماجستير محاسبة، خبرة +30 سنة)',
        ...
        function addMessage(text, sender, isAI) {
            ...
            var avatarHtml = sender === 'bot'
                ? '<img src="https://alfatlawy-cpa.com.iq/wp-content/uploads/2024/11/Untitled_design-removebg-preview.png" alt="bot" style="width:24px;height:24px;object-fit:contain;border-radius:6px;">'
